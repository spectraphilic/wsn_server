...
SCHEMAS = {
    ...
    'cr6_finseflux': {
        ...
        'RECORD': Field(type='UInt32', source='RECORD'),
        'Ux': Field(source='Ux'),
        'Uy': Field(source='Uy'),
        'Uz': Field(source='Uz'),
        'SOS': Field(source='SOS'),
        'sonic_diag': Field(source='sonic_diag'),
        'CO2_dry': Field(source='CO2_dry'),
        'H2O_dry': Field(source='H2O_dry'),
        'CO2': Field(source='CO2'),
        'H2O': Field(source='H2O'),
        'AGC': Field(source='AGC'),
        'Ptotal': Field(source='Ptotal'),
        'T_in': Field(source='T_in'),
        'T_out': Field(source='T_out'),
        'U_ana': Field(source='U_ana'),
        'V_ana': Field(source='V_ana'),
        'W_ana': Field(source='W_ana'),
        'SOS_ana': Field(source='SOS_ana'),
    },
    'licor_finsefetene': {
        'TIMESTAMP': Field(type="DateTime64(3, 'UTC')"),
